...
public:
    ...
    UFUNCTION(BlueprintNativeEvent, Category = "Dungeon")
    void OnMarkersEmitted(ADungeon* Dungeon, UPARAM(ref) TArray<FDungeonMarkerBuildData>& MarkerList,
                          TArray<FDungeonMarkerBuildData>& MarkerListRef);
    virtual void OnMarkersEmitted_Implementation(ADungeon* Dungeon, UPARAM(ref) TArray<FDungeonMarkerBuildData>& MarkerList,
                                                 TArray<FDungeonMarkerBuildData>& MarkerListRef);
