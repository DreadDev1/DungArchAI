...
public:
	...
	virtual bool Process(const UMarkerGenLayer* InLayer, const TArray<FDungeonMarkerInstance>& InMarkers, const FRandomStream& InRandom, TArray<FDungeonMarkerInstance>& OutMarkers) override;
